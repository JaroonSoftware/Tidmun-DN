...
$sql = "SELECT a.barcode_id,a.unit_weight, a.stcode,i.stname , a.grcode, a.barcode_status,s.supcode,s.supname, a.socode, a.dncode,c.cuscode,c.cusname, a.created_date, a.updated_date 
FROM items_barcode a 
